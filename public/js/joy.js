class Joy {
    ...
    MouseDown(e) {
        this.clicked = true
        this.click(e.pageX - this.container.get(0).offsetLeft, e.pageY - this.container.get(0).offsetTop)
    }
    MouseMove(e) {
        if (this.clicked) {
            this.click(e.pageX - this.container.get(0).offsetLeft, e.pageY - this.container.get(0).offsetTop)
    ...
    TouchDown(e) {
        this.clicked = true
        this.click(e.targetTouches[0].pageX - this.container.get(0).offsetLeft, e.targetTouches[0].pageY - this.container.get(0).offsetTop)
    }
    TouchMove(e) {
        if (this.clicked) {
            this.click(e.targetTouches[0].pageX - this.container.get(0).offsetLeft, e.targetTouches[0].pageY - this.container.get(0).offsetTop)
